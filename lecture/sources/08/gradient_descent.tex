...
\begin{frame}{Gradient Descent for Logistic Regression}
  ...
  \note{
    \begin{itemize}
      \item Random initialization for classification problem with logistic regression and gradient descent.
      \item Green arrow is the normalized weight vector.
      \item Blue line indicates decision boundary including the bias.
    \end{itemize}
  }
\end{frame}
...
\begin{frame}{Gradient Descent for Logistic Regression}
  ...
  \note{
    \begin{itemize}
      \item The six graphs show step 0, 20, 60, 80, 100, 180 of the gradient descent.
    \end{itemize}
  }
\end{frame}
